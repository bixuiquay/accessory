...
export class ProductService {
  ...
  async addProduct(createProduct: ProductCreateRequest): Promise<ProductResponse> {
    const saveEntity = {
      ...
      priceSale: createProduct.priceSale,
      feature: createProduct.isFeatured,
      lastminute: createProduct.isLastMinute,
      flashsale: createProduct.isFlashSale,
      wishlist: createProduct.isWishlist,
